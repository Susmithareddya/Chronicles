      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stories.map((story) => (
            <Card 
              key={story.id}
              className="cursor-pointer group relative overflow-hidden bg-white backdrop-blur-xl border border-white/20 hover:border-white/30 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 glass-card"
