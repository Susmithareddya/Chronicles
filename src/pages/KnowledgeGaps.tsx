      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-amber-50/30">
        ...
        <div className="space-y-6">
          {knowledgeGaps.map((gap) => (
            <Card 
              key={gap.id}
              className="bg-white border border-slate-200 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <CardContent className="p-8">
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <Button className="bg-blue-600 hover:bg-blue-700 text-white border-0 rounded-full px-6 py-2 h-auto font-medium transition-all duration-200 hover:shadow-md">
